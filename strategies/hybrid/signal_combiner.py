...
class SignalCombiner:
    ...
    def combine_signals(self, 
                       signals: List[Dict], 
                       weights: Optional[Dict[str, float]] = None) -> List[CombinedSignal]:
    ...
    def _combine_symbol_signals(self, 
                              signals: List[Dict], 
                              weights: Optional[Dict[str, float]] = None) -> Optional[CombinedSignal]:
    ...
    def _weighted_average_combine(self, 
                                signals: List[Dict], 
                                weights: Optional[Dict[str, float]] = None) -> CombinedSignal:
